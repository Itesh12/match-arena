      ...
      <div className="relative z-10 flex-1 p-6 lg:p-12 flex flex-col h-full lg:min-h-screen">
        {gameStatus === 'waiting' ? (
          <div className="flex-1 flex flex-col h-full overflow-y-auto">
            ...
            <header className="grid grid-cols-3 items-center w-full max-w-7xl mx-auto pt-8 pb-12 px-6">
              {/* Left: Players Info - Compact and matching sidebar style */}
              <div className="flex justify-start">
                <div className="flex items-center gap-4 px-6 py-5 bg-white/[0.03] rounded-2xl border border-white/10 group hover:border-blue-500/30 transition-all duration-500">
                  <div className="relative">
              ...
              <div className="flex justify-center">
                <div className="relative group cursor-default">
                  ...
                  <div className="relative flex items-center gap-6 px-10 py-6 glass rounded-full border border-white/5 shadow-2xl overflow-hidden group-hover:border-white/10 transition-all duration-700">
              ...
              <div className="flex justify-end items-center gap-4">
                <div className="flex items-center gap-4 px-6 py-5 bg-white/[0.03] rounded-2xl border border-white/10 group/lang hover:border-white/20 transition-all duration-500">
